<?php
	function historialPedidosfecha($db, $id, $fecha1, $fecha2) {
		$sql = "SELECT InvoiceId, InvoiceDate, Total FROM Invoice WHERE CustomerId = '$id' AND InvoiceDate BETWEEN '$fecha1' AND '$fecha2'";
		$query = mysqli_query($db, $sql);
		
		echo '<div style="border: 3px solid grey; border-radius: 30px 30px 30px 30px;">';
		echo '<br/><br/>';
		echo "<center><h3 style='color: black;'>Historial de tus pedidos desde '$fecha1' a '$fecha2'</h3></center>";
		echo '<br/>';
